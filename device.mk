...
# Audio
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/audio/audioeffects.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audioeffects.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/etc/ueventd.qcom.rc:$(TARGET_COPY_OUT_VENDOR)/etc/ueventd.qcom.rc
